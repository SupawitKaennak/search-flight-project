...
CREATE TABLE IF NOT EXISTS flight_prices (
  ...
  -- New fields for flight price table requirements
  origin_group VARCHAR(50),
  dep_airport VARCHAR(10), -- Departure airport code
  arr_airport VARCHAR(10), -- Arrival airport code
  -- destination is chemically redundant with routes table but requested for denormalization
  destination VARCHAR(50), 
  airline_name VARCHAR(100), -- Denormalized airline name
  airline_code VARCHAR(10), -- Denormalized airline code
  price_text VARCHAR(50), -- Formatted price text
